...
// 2. Dedicated Hinglish (Hindi in Roman script) Local Cuss Words and Speech (pmathur5k10 dataset & comprehensive regional lexicon)
const HINGLISH_PROFANITIES: ProfanityEntry[] = [
  ...
  { term: "bahenchod", severity: "HIGH", language: "Hinglish (Hindi)", category: "SEVERE_PROFANITY_OR_ABUSE" },
  { term: "bahanchod", severity: "HIGH", language: "Hinglish (Hindi)", category: "SEVERE_PROFANITY_OR_ABUSE" },
  { term: "behnchod", severity: "HIGH", language: "Hinglish (Hindi)", category: "SEVERE_PROFANITY_OR_ABUSE" },
  { term: "bahencho", severity: "HIGH", language: "Hinglish (Hindi)", category: "SEVERE_PROFANITY_OR_ABUSE" },
  { term: "bancho", severity: "HIGH", language: "Hinglish (Hindi)", category: "SEVERE_PROFANITY_OR_ABUSE" },
  { term: "bhaichod", severity: "HIGH", language: "Hinglish (Hindi)", category: "SEVERE_PROFANITY_OR_ABUSE" },
  { term: "betichod", severity: "HIGH", language: "Hinglish (Hindi)", category: "SEVERE_PROFANITY_OR_ABUSE" },
  ...
  { term: "bhootnika", severity: "HIGH", language: "Hinglish (Hindi)", category: "SEVERE_PROFANITY_OR_ABUSE" },
  { term: "bhootnike", severity: "HIGH", language: "Hinglish (Hindi)", category: "SEVERE_PROFANITY_OR_ABUSE" },
  ...
  { term: "randipana", severity: "HIGH", language: "Hinglish (Hindi)", category: "SEVERE_PROFANITY_OR_ABUSE" },
  { term: "chinaal", severity: "HIGH", language: "Hinglish (Hindi)", category: "SEVERE_PROFANITY_OR_ABUSE" },
  { term: "ghasti", severity: "HIGH", language: "Hinglish (Hindi)", category: "SEVERE_PROFANITY_OR_ABUSE" },
  { term: "gasti", severity: "HIGH", language: "Hinglish (Hindi)", category: "SEVERE_PROFANITY_OR_ABUSE" },
  ...
  { term: "gandpaidaish", severity: "HIGH", language: "Hinglish (Hindi)", category: "SEVERE_PROFANITY_OR_ABUSE" },
  { term: "gandfat", severity: "HIGH", language: "Hinglish (Hindi)", category: "SEVERE_PROFANITY_OR_ABUSE" },
  { term: "gandfaad", severity: "HIGH", language: "Hinglish (Hindi)", category: "SEVERE_PROFANITY_OR_ABUSE" },
  { term: "choot", severity: "HIGH", language: "Hinglish (Hindi)", category: "SEVERE_PROFANITY_OR_ABUSE" },
  ...
  { term: "lauda", severity: "HIGH", language: "Hinglish (Hindi)", category: "SEVERE_PROFANITY_OR_ABUSE" },
  ...
  { term: "land", severity: "HIGH", language: "Hinglish (Hindi)", category: "SEVERE_PROFANITY_OR_ABUSE" },
  { term: "jhaant", severity: "HIGH", language: "Hinglish (Hindi)", category: "SEVERE_PROFANITY_OR_ABUSE" },
  { term: "jhant", severity: "HIGH", language: "Hinglish (Hindi)", category: "SEVERE_PROFANITY_OR_ABUSE" },
  { term: "jhattu", severity: "HIGH", language: "Hinglish (Hindi)", category: "SEVERE_PROFANITY_OR_ABUSE" },
  { term: "jhalla", severity: "HIGH", language: "Hinglish (Hindi)", category: "SEVERE_PROFANITY_OR_ABUSE" },
  { term: "bakland", severity: "HIGH", language: "Hinglish (Hindi)", category: "SEVERE_PROFANITY_OR_ABUSE" },
  { term: "badirchand", severity: "HIGH", language: "Hinglish (Hindi)", category: "SEVERE_PROFANITY_OR_ABUSE" },
  ...
  { term: "bahen ke laude", severity: "HIGH", language: "Hinglish (Hindi)", category: "SEVERE_PROFANITY_OR_ABUSE", isPhrase: true },
  { term: "bahenke", severity: "HIGH", language: "Hinglish (Hindi)", category: "SEVERE_PROFANITY_OR_ABUSE" },
  ...
  { term: "chudwana", severity: "HIGH", language: "Hinglish (Hindi)", category: "SEVERE_PROFANITY_OR_ABUSE" },
  { term: "chudaye", severity: "HIGH", language: "Hinglish (Hindi)", category: "SEVERE_PROFANITY_OR_ABUSE" },
  ...
  { term: "hinjda", severity: "HIGH", language: "Hinglish (Hindi)", category: "HATE_SPEECH" },
  { term: "chakke", severity: "HIGH", language: "Hinglish (Hindi)", category: "HATE_SPEECH" },
  { term: "najayaz", severity: "HIGH", language: "Hinglish (Hindi)", category: "SEVERE_PROFANITY_OR_ABUSE" },
  ...
  { term: "chutad", severity: "MEDIUM", language: "Hinglish (Hindi)", category: "SEVERE_PROFANITY_OR_ABUSE" },
  { term: "chuttad", severity: "MEDIUM", language: "Hinglish (Hindi)", category: "SEVERE_PROFANITY_OR_ABUSE" },
  { term: "bhadwa", severity: "MEDIUM", language: "Hinglish (Hindi)", category: "SEVERE_PROFANITY_OR_ABUSE" },
  { term: "bhadva", severity: "MEDIUM", language: "Hinglish (Hindi)", category: "SEVERE_PROFANITY_OR_ABUSE" },
  ...
  { term: "haraam", severity: "MEDIUM", language: "Hinglish (Hindi)", category: "SEVERE_PROFANITY_OR_ABUSE" },
  ...
  { term: "haraamkhor", severity: "MEDIUM", language: "Hinglish (Hindi)", category: "SEVERE_PROFANITY_OR_ABUSE" },
  ...
  { term: "kutiya", severity: "MEDIUM", language: "Hinglish (Hindi)", category: "SEVERE_PROFANITY_OR_ABUSE" },
  { term: "kutti", severity: "MEDIUM", language: "Hinglish (Hindi)", category: "SEVERE_PROFANITY_OR_ABUSE" },
  ...
  { term: "badir", severity: "MEDIUM", language: "Hinglish (Hindi)", category: "SEVERE_PROFANITY_OR_ABUSE" },
  { term: "soover", severity: "MEDIUM", language: "Hinglish (Hindi)", category: "SEVERE_PROFANITY_OR_ABUSE" },
  { term: "auladheen", severity: "MEDIUM", language: "Hinglish (Hindi)", category: "SEVERE_PROFANITY_OR_ABUSE" },
  { term: "khota", severity: "MEDIUM", language: "Hinglish (Hindi)", category: "SEVERE_PROFANITY_OR_ABUSE" },
  { term: "nabaal", severity: "MEDIUM", language: "Hinglish (Hindi)", category: "SEVERE_PROFANITY_OR_ABUSE" },
  { term: "pissu", severity: "LOW", language: "Hinglish (Hindi)", category: "SEVERE_PROFANITY_OR_ABUSE" },
  ...
  { term: "potty", severity: "LOW", language: "Hinglish (Hindi)", category: "SEVERE_PROFANITY_OR_ABUSE" },
