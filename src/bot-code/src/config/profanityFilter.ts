...
// 2. Hindi & Hinglish Local Cuss Words and Speech
const HINDI_PROFANITIES: ProfanityEntry[] = [
  // Severe / Slurs - Hinglish & Devanagari
  { term: "madarchod", severity: "HIGH", language: "Hindi (Hinglish)", category: "SEVERE_PROFANITY_OR_ABUSE" },
  { term: "maderchod", severity: "HIGH", language: "Hindi (Hinglish)", category: "SEVERE_PROFANITY_OR_ABUSE" },
  { term: "madarchodh", severity: "HIGH", language: "Hindi (Hinglish)", category: "SEVERE_PROFANITY_OR_ABUSE" },
  { term: "madarjaat", severity: "HIGH", language: "Hindi (Hinglish)", category: "SEVERE_PROFANITY_OR_ABUSE" },
  { term: "bhenchod", severity: "HIGH", language: "Hindi (Hinglish)", category: "SEVERE_PROFANITY_OR_ABUSE" },
  { term: "behenchod", severity: "HIGH", language: "Hindi (Hinglish)", category: "SEVERE_PROFANITY_OR_ABUSE" },
  { term: "behnchod", severity: "HIGH", language: "Hindi (Hinglish)", category: "SEVERE_PROFANITY_OR_ABUSE" },
  { term: "bhosdike", severity: "HIGH", language: "Hindi (Hinglish)", category: "SEVERE_PROFANITY_OR_ABUSE" },
  { term: "bhosadike", severity: "HIGH", language: "Hindi (Hinglish)", category: "SEVERE_PROFANITY_OR_ABUSE" },
  { term: "bhosdi", severity: "HIGH", language: "Hindi (Hinglish)", category: "SEVERE_PROFANITY_OR_ABUSE" },
  { term: "bhosda", severity: "HIGH", language: "Hindi (Hinglish)", category: "SEVERE_PROFANITY_OR_ABUSE" },
  { term: "bsdk", severity: "HIGH", language: "Hindi (Hinglish)", category: "SEVERE_PROFANITY_OR_ABUSE" },
  { term: "bsdwale", severity: "HIGH", language: "Hindi (Hinglish)", category: "SEVERE_PROFANITY_OR_ABUSE" },
  { term: "randi", severity: "HIGH", language: "Hindi (Hinglish)", category: "SEVERE_PROFANITY_OR_ABUSE" },
  { term: "rndi", severity: "HIGH", language: "Hindi (Hinglish)", category: "SEVERE_PROFANITY_OR_ABUSE" },
  { term: "randwa", severity: "HIGH", language: "Hindi (Hinglish)", category: "SEVERE_PROFANITY_OR_ABUSE" },
  { term: "gandu", severity: "HIGH", language: "Hindi (Hinglish)", category: "SEVERE_PROFANITY_OR_ABUSE" },
  { term: "gaandu", severity: "HIGH", language: "Hindi (Hinglish)", category: "SEVERE_PROFANITY_OR_ABUSE" },
  { term: "gaand", severity: "HIGH", language: "Hindi (Hinglish)", category: "SEVERE_PROFANITY_OR_ABUSE" },
  { term: "lund", severity: "HIGH", language: "Hindi (Hinglish)", category: "SEVERE_PROFANITY_OR_ABUSE" },
  { term: "laude", severity: "HIGH", language: "Hindi (Hinglish)", category: "SEVERE_PROFANITY_OR_ABUSE" },
  { term: "lawda", severity: "HIGH", language: "Hindi (Hinglish)", category: "SEVERE_PROFANITY_OR_ABUSE" },
  { term: "loda", severity: "HIGH", language: "Hindi (Hinglish)", category: "SEVERE_PROFANITY_OR_ABUSE" },
  { term: "lodu", severity: "HIGH", language: "Hindi (Hinglish)", category: "SEVERE_PROFANITY_OR_ABUSE" },
  { term: "jhaant", severity: "HIGH", language: "Hindi (Hinglish)", category: "SEVERE_PROFANITY_OR_ABUSE" },
  { term: "bhen ke lode", severity: "HIGH", language: "Hindi (Hinglish)", category: "SEVERE_PROFANITY_OR_ABUSE", isPhrase: true },
  { term: "teri maa ki", severity: "HIGH", language: "Hindi (Hinglish)", category: "SEVERE_PROFANITY_OR_ABUSE", isPhrase: true },
  { term: "teri bhen ki", severity: "HIGH", language: "Hindi (Hinglish)", category: "SEVERE_PROFANITY_OR_ABUSE", isPhrase: true },
  { term: "chodna", severity: "HIGH", language: "Hindi (Hinglish)", category: "SEVERE_PROFANITY_OR_ABUSE" },
  { term: "chudai", severity: "HIGH", language: "Hindi (Hinglish)", category: "SEVERE_PROFANITY_OR_ABUSE" },
  { term: "chudap", severity: "MEDIUM", language: "Hindi (Hinglish)", category: "SEVERE_PROFANITY_OR_ABUSE" },
  ...
  // Medium / Casual Insults - Hinglish & Devanagari
  { term: "chutiya", severity: "MEDIUM", language: "Hindi (Hinglish)", category: "SEVERE_PROFANITY_OR_ABUSE" },
  { term: "chootiya", severity: "MEDIUM", language: "Hindi (Hinglish)", category: "SEVERE_PROFANITY_OR_ABUSE" },
  { term: "chutya", severity: "MEDIUM", language: "Hindi (Hinglish)", category: "SEVERE_PROFANITY_OR_ABUSE" },
  { term: "chutia", severity: "MEDIUM", language: "Hindi (Hinglish)", category: "SEVERE_PROFANITY_OR_ABUSE" },
  { term: "bhadwa", severity: "MEDIUM", language: "Hindi (Hinglish)", category: "SEVERE_PROFANITY_OR_ABUSE" },
  { term: "bhadwe", severity: "MEDIUM", language: "Hindi (Hinglish)", category: "SEVERE_PROFANITY_OR_ABUSE" },
  { term: "harami", severity: "MEDIUM", language: "Hindi (Hinglish)", category: "SEVERE_PROFANITY_OR_ABUSE" },
  { term: "haraami", severity: "MEDIUM", language: "Hindi (Hinglish)", category: "SEVERE_PROFANITY_OR_ABUSE" },
  { term: "kutta", severity: "MEDIUM", language: "Hindi (Hinglish)", category: "SEVERE_PROFANITY_OR_ABUSE" },
  { term: "kutte", severity: "MEDIUM", language: "Hindi (Hinglish)", category: "SEVERE_PROFANITY_OR_ABUSE" },
  { term: "kamina", severity: "MEDIUM", language: "Hindi (Hinglish)", category: "SEVERE_PROFANITY_OR_ABUSE" },
  { term: "kamine", severity: "MEDIUM", language: "Hindi (Hinglish)", category: "SEVERE_PROFANITY_OR_ABUSE" },
  { term: "saale", severity: "MEDIUM", language: "Hindi (Hinglish)", category: "SEVERE_PROFANITY_OR_ABUSE" },
  { term: "bakchod", severity: "MEDIUM", language: "Hindi (Hinglish)", category: "SEVERE_PROFANITY_OR_ABUSE" },
  { term: "bakchodi", severity: "MEDIUM", language: "Hindi (Hinglish)", category: "SEVERE_PROFANITY_OR_ABUSE" },
  { term: "chomu", severity: "MEDIUM", language: "Hindi (Hinglish)", category: "SEVERE_PROFANITY_OR_ABUSE" },
  { term: "tharki", severity: "MEDIUM", language: "Hindi (Hinglish)", category: "SEVERE_PROFANITY_OR_ABUSE" },
  { term: "ullu ke patthe", severity: "MEDIUM", language: "Hindi (Hinglish)", category: "SEVERE_PROFANITY_OR_ABUSE", isPhrase: true },
